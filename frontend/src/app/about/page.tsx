...
export default function AboutPage() {
  return (
    <SiteShell active="About Us">
      ...
      <section className="border-b border-white/10 bg-[#042448]">
        <div className="mx-auto grid max-w-[1260px] grid-cols-2 divide-x divide-y divide-white/15 sm:grid-cols-2 md:grid-cols-4 md:divide-y-0">
          {stats.map((item) => (
            <div key={item.label} className="px-2 py-5 text-center sm:px-3 sm:py-6">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          >
            ...
            <div className="mt-3 flex items-center gap-3 border-l-[3px] border-[#e30613] pl-4">
              ...
              <p className="text-sm font-semibold text-[#0b2f57]">Years of experience serving travelers worldwide</p>
            </div>
          </motion.div>
